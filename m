...
Received: from smtp1.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 90A8C92792B
	for <lists+driverdev-devel@lfdr.de>; Thu,  4 Jul 2024 16:47:49 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp1.osuosl.org (Postfix) with ESMTP id A147A8470A;
	Thu,  4 Jul 2024 14:47:47 +0000 (UTC)
X-Virus-Scanned: amavis at osuosl.org
Received: from smtp1.osuosl.org ([127.0.0.1])
 by localhost (smtp1.osuosl.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id oPcTTV6i7wAs; Thu,  4 Jul 2024 14:47:46 +0000 (UTC)
X-Comment: SPF check N/A for local connections - client-ip=140.211.166.34; helo=ash.osuosl.org; envelope-from=driverdev-devel-bounces@linuxdriverproject.org; receiver=<UNKNOWN> 
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp1.osuosl.org 7E88E8478F
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp1.osuosl.org (Postfix) with ESMTP id 7E88E8478F;
	Thu,  4 Jul 2024 14:47:46 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by ash.osuosl.org (Postfix) with ESMTP id C2F9E1BF2C3
 for <devel@linuxdriverproject.org>; Thu,  4 Jul 2024 14:47:44 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id BA4FE413EC
 for <devel@linuxdriverproject.org>; Thu,  4 Jul 2024 14:47:44 +0000 (UTC)
X-Virus-Scanned: amavis at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
 by localhost (smtp4.osuosl.org [127.0.0.1]) (amavis, port 10024) with ESMTP
 id HjsZTOd7pxJA for <devel@linuxdriverproject.org>;
 Thu,  4 Jul 2024 14:47:43 +0000 (UTC)
Received-SPF: Pass (mailfrom) identity=mailfrom; client-ip=198.175.65.9;
 helo=mgamail.intel.com; envelope-from=lkp@intel.com; receiver=<UNKNOWN> 
DMARC-Filter: OpenDMARC Filter v1.4.2 smtp4.osuosl.org 128F7406C2
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp4.osuosl.org 128F7406C2
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by smtp4.osuosl.org (Postfix) with ESMTPS id 128F7406C2
 for <devel@driverdev.osuosl.org>; Thu,  4 Jul 2024 14:47:42 +0000 (UTC)
X-CSE-ConnectionGUID: de/ggOiqSZmL3YuXCoxoMQ==
X-CSE-MsgGUID: srBfsbx+QHCi9PUzrGKIfw==
X-IronPort-AV: E=McAfee;i="6700,10204,11123"; a="39902457"
X-IronPort-AV: E=Sophos;i="6.09,183,1716274800"; d="scan'208";a="39902457"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jul 2024 07:47:42 -0700
X-CSE-ConnectionGUID: B7qkRr0gQh6F/fJf69O1wQ==
X-CSE-MsgGUID: TX2oiGjsSKCcZldmqcDJPQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,183,1716274800"; d="scan'208";a="77356546"
Received: from lkp-server01.sh.intel.com (HELO 68891e0c336b) ([10.239.97.150])
 by orviesa002.jf.intel.com with ESMTP; 04 Jul 2024 07:47:41 -0700
Received: from kbuild by 68891e0c336b with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1sPNkI-000R6i-26;
 Thu, 04 Jul 2024 14:47:38 +0000
Date: Thu, 04 Jul 2024 22:47:09 +0800
From: kernel test robot <lkp@intel.com>
To: "Greg Kroah-Hartman" <gregkh@linuxfoundation.org>
Subject: [staging:staging-testing] BUILD SUCCESS
 d3401cefd0f793037df0f36e12c2effdac517de1
Message-ID: <202407042207.B2inpWSY-lkp@intel.com>
User-Agent: s-nail v14.9.24
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1720104463; x=1751640463;
 h=date:from:to:cc:subject:message-id;
 bh=Yd7Gn9O71WFGE9fY5A+bd6V3hWBUII1VonBQFG8q5U8=;
 b=TtOPv5GuCdRfy6NURC8KDgUtMmTLwxRRhA8pTWTrO5cFy9AgnnlC7BpI
 ksvWan7F9JLK/H961XefEc2jpsCUb9jin+kdLt2y7iGB1Pl8Mjmxp6mZf
 VwKchf7NyOeyoRBmNiJnj0poOdleKABGp4piiWnXCz8ORQA+IkSkRy/8e
 KOFqYunPwd94tTuQwodMjToygs7aUG0zq96b36UCVML0SYfvXa2l4gN5V
 jJkl46sr65dG8++G8XZWhfb9I3uHfyQ+AHJp4KTD0y1WkHTnDIPW32J+f
 Cln121fH9IPtbmZxBRmgoBzNF4ofKFYxFCqrVKf5n140gAdkVXemeebD9
 w==;
...
X-Mailman-Original-Authentication-Results: smtp4.osuosl.org;
 ...
 header.s=Intel header.b=TtOPv5Gu
...
branch HEAD: d3401cefd0f793037df0f36e12c2effdac517de1  staging: nvec: Use x instead of x != NULL to improve readability.
