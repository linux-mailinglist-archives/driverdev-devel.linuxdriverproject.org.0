...
Authentication-Results: mail.lcent.com;
	none
X-Spamd-Result: default: False [3.95 / 15.00]; ARC_NA(0.00)[];
 HAS_REPLYTO(0.00)[steve_dickson@firemail.eu];
 FAKE_REPLY(1.00)[]; FROM_HAS_DN(0.00)[];
 TO_MATCH_ENVRCPT_ALL(0.00)[]; MIME_GOOD(-0.10)[text/plain];
 REPLYTO_DOM_NEQ_FROM_DOM(0.00)[]; TO_DN_NONE(0.00)[];
 RCPT_COUNT_ONE(0.00)[1]; BAD_WORDS(0.10)[];
 SUBJ_ALL_CAPS(1.95)[26]; SUBJECT_ENDS_EXCLAIM(0.00)[];
