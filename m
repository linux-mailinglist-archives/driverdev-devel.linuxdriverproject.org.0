...
Received: from hemlock.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id CBED4251512
	for <lists+driverdev-devel@lfdr.de>; Tue, 25 Aug 2020 11:13:35 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by hemlock.osuosl.org (Postfix) with ESMTP id 8FD12882A1;
	Tue, 25 Aug 2020 09:13:33 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from hemlock.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 4+kKDlDbXDyP; Tue, 25 Aug 2020 09:13:33 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by hemlock.osuosl.org (Postfix) with ESMTP id DB6948815E;
	Tue, 25 Aug 2020 09:13:32 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by ash.osuosl.org (Postfix) with ESMTP id 8F6F71BF2B0
 for <devel@linuxdriverproject.org>; Tue, 25 Aug 2020 09:13:30 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 855C787E5F
 for <devel@linuxdriverproject.org>; Tue, 25 Aug 2020 09:13:30 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 0xFCQHSf05vq for <devel@linuxdriverproject.org>;
 Tue, 25 Aug 2020 09:13:29 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from NAM11-BN8-obe.outbound.protection.outlook.com
 (mail-bn8nam11on2044.outbound.protection.outlook.com [40.107.236.44])
 by whitealder.osuosl.org (Postfix) with ESMTPS id B500387841
 for <devel@driverdev.osuosl.org>; Tue, 25 Aug 2020 09:13:29 +0000 (UTC)
...
Subject: [PATCH v2 12/12] staging: wfx: add workaround for 'timeout while wake
 up chip'
...
Received: from 255.255.255.255 (255.255.255.255) by
 ...
 15.20.3326.19 via Frontend Transport; Tue, 25 Aug 2020 08:59:12 +0000
X-Mailer: git-send-email 2.28.0
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(136003)(39840400004)(396003)(346002)(376002)(366004)(316002)(5660300002)(478600001)(107886003)(1076003)(8936002)(83380400001)(16576012)(956004)(66556008)(66476007)(26005)(2616005)(186003)(8676002)(86362001)(66946007)(6486002)(54906003)(6666004)(36756003)(4326008)(66574015)(2906002)(52116002);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Aug 2020 08:59:13.8102 (UTC)
...
CQl9CiAJfQogfQogCi0tIAoyLjI4LjAKCl9fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19f
