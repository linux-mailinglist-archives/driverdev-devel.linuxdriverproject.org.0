...
Received: from smtp4.osuosl.org (smtp4.osuosl.org [IPv6:2605:bc80:3010::137])
	by mail.lfdr.de (Postfix) with ESMTPS id BFDBB6369C7
	for <lists+driverdev-devel@lfdr.de>; Wed, 23 Nov 2022 20:19:50 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp4.osuosl.org (Postfix) with ESMTP id D53F141955;
	Wed, 23 Nov 2022 19:19:46 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp4.osuosl.org D53F141955
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
	by localhost (smtp4.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id zSS--q9ZUGOJ; Wed, 23 Nov 2022 19:19:43 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp4.osuosl.org (Postfix) with ESMTP id 28B7441961;
	Wed, 23 Nov 2022 19:19:43 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp4.osuosl.org 28B7441961
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp3.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by ash.osuosl.org (Postfix) with ESMTP id 47ADC1BF314
 for <devel@linuxdriverproject.org>; Wed, 23 Nov 2022 19:19:40 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp3.osuosl.org (Postfix) with ESMTP id 2D6F460B9A
 for <devel@linuxdriverproject.org>; Wed, 23 Nov 2022 19:19:40 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp3.osuosl.org 2D6F460B9A
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp3.osuosl.org ([127.0.0.1])
 by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id mRLcjSyE0HgE for <devel@linuxdriverproject.org>;
 Wed, 23 Nov 2022 19:19:37 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp3.osuosl.org 9842E60B2A
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by smtp3.osuosl.org (Postfix) with ESMTPS id 9842E60B2A
 for <devel@driverdev.osuosl.org>; Wed, 23 Nov 2022 19:19:36 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="315964478"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; d="scan'208";a="315964478"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Nov 2022 11:19:35 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10540"; a="816590355"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; d="scan'208";a="816590355"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
 by orsmga005.jf.intel.com with ESMTP; 23 Nov 2022 11:19:33 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1oxvHQ-000325-2V;
 Wed, 23 Nov 2022 19:19:32 +0000
Date: Thu, 24 Nov 2022 03:18:58 +0800
From: kernel test robot <lkp@intel.com>
To: Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: [driver-core:kobject-const2 9/11]
 drivers/macintosh/macio_asic.c:136:18: error: initialization of 'int
 (*)(struct device *, struct kobj_uevent_env *)' from incompatible pointer
 type 'int (*)(const struct device *, struct kobj_uevent_env *)'
Message-ID: <202211240329.4Vy3QrMn-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="b8XAzf75RpRBeUP8"
Content-Disposition: inline
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669231176; x=1700767176;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=c1XGzZLzj7r26ZKSiVSndOH2PSzvblRXNJu1IJGmzOg=;
 b=QmUkdahpot1I3JrOhMEQG+Cme4uoXP3zexMW3emQIchLLoi4i6MsZGib
 vbca9k9cz+ALQVOQq3APDbT4trUQ0yjcFTVg83LFvp79pr2Vg+yTKSpNg
 OGaloG+DtfwWVvD++EIfLgqMiAx0pRGHp9239jMYC1d2GingjPcNxBD9C
 fWoFm5+E/YDPFk11GA8O3nHcFjYX/D4AiyT3fZ/FXCblQ+wFskmoK08+t
 5h2SUQuND6RhzU04azGbeQV2OOCdL82Wo7Je8f4rj5lhI/UNUBj8xZN9r
 KsHES/yvk/xP+JbIZJuL2aV7EW+N/X5zvudknls49jnxyb0zGzY5ZP8pg
 Q==;
X-Mailman-Original-Authentication-Results: smtp3.osuosl.org;
 dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com
 header.a=rsa-sha256 header.s=Intel header.b=QmUkdahp
...
head:   a24f87696c63e8564c4e04b8715daaca5e2144c9
commit: b3449bde9a71c29702f8860c2f718ef8055cb4e0 [9/11] driver core: make struct device_type.uevent() take a const *
config: powerpc-allmodconfig
compiler: powerpc-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core.git/commit/?id=b3449bde9a71c29702f8860c2f718ef8055cb4e0
        git remote add driver-core https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core.git
        git fetch --no-tags driver-core kobject-const2
        git checkout b3449bde9a71c29702f8860c2f718ef8055cb4e0
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=powerpc SHELL=/bin/bash drivers/macintosh/
...
>> drivers/macintosh/macio_asic.c:136:18: error: initialization of 'int (*)(struct device *, struct kobj_uevent_env *)' from incompatible pointer type 'int (*)(const struct device *, struct kobj_uevent_env *)' [-Werror=incompatible-pointer-types]
     136 |        .uevent = of_device_uevent_modalias,
         |                  ^~~~~~~~~~~~~~~~~~~~~~~~~
   drivers/macintosh/macio_asic.c:136:18: note: (near initialization for 'macio_bus_type.uevent')
   cc1: some warnings being treated as errors


vim +136 drivers/macintosh/macio_asic.c

b5bf5b6786ccfc Jeff Mahoney       2005-07-06  132  
^1da177e4c3f41 Linus Torvalds     2005-04-16  133  struct bus_type macio_bus_type = {
^1da177e4c3f41 Linus Torvalds     2005-04-16  134         .name	= "macio",
^1da177e4c3f41 Linus Torvalds     2005-04-16  135         .match	= macio_bus_match,
07d57a32fb6eb2 Grant Likely       2012-02-01 @136         .uevent = of_device_uevent_modalias,
4866b124a1ded3 Russell King       2006-01-05  137         .probe	= macio_device_probe,
4866b124a1ded3 Russell King       2006-01-05  138         .remove	= macio_device_remove,
4866b124a1ded3 Russell King       2006-01-05  139         .shutdown = macio_device_shutdown,
^1da177e4c3f41 Linus Torvalds     2005-04-16  140         .suspend	= macio_device_suspend,
^1da177e4c3f41 Linus Torvalds     2005-04-16  141         .resume	= macio_device_resume,
60bb70aa761ca4 Greg Kroah-Hartman 2017-06-06  142         .dev_groups = macio_dev_groups,
