...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B09C288FF8
	for <lists+driverdev-devel@lfdr.de>; Fri,  9 Oct 2020 19:28:01 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id 07C9287836;
	Fri,  9 Oct 2020 17:27:59 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id x5yAUWc4GGEn; Fri,  9 Oct 2020 17:27:58 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by whitealder.osuosl.org (Postfix) with ESMTP id 5E56F87535;
	Fri,  9 Oct 2020 17:27:56 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by ash.osuosl.org (Postfix) with ESMTP id B0E7F1BF576
 for <devel@linuxdriverproject.org>; Fri,  9 Oct 2020 17:27:54 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id A60102E2D9
 for <devel@linuxdriverproject.org>; Fri,  9 Oct 2020 17:27:54 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id d7jPZuvLexpv for <devel@linuxdriverproject.org>;
 Fri,  9 Oct 2020 17:27:52 +0000 (UTC)
X-Greylist: delayed 00:14:08 by SQLgrey-1.7.6
Received: from NAM02-BL2-obe.outbound.protection.outlook.com
 (mail-eopbgr750078.outbound.protection.outlook.com [40.107.75.78])
 by silver.osuosl.org (Postfix) with ESMTPS id DB1162E2D8
 for <devel@driverdev.osuosl.org>; Fri,  9 Oct 2020 17:27:51 +0000 (UTC)
...
Subject: [PATCH 3/8] staging: wfx: standardize the error when vif does not
 exist
...
Received: from pc-42.silabs.com (82.67.86.106) by
 ...
 15.20.3455.24 via Frontend Transport; Fri, 9 Oct 2020 17:13:26 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(366004)(346002)(376002)(39850400004)(396003)(136003)(8936002)(36756003)(54906003)(1076003)(316002)(52116002)(7696005)(2906002)(5660300002)(478600001)(66574015)(86362001)(4326008)(66946007)(66556008)(66476007)(6666004)(107886003)(26005)(16526019)(2616005)(83380400001)(186003)(8676002)(956004)(6486002);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Oct 2020 17:13:27.8153 (UTC)
