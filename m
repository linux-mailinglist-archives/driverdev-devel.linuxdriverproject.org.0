...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id 4345911A969
	for <lists+driverdev-devel@lfdr.de>; Wed, 11 Dec 2019 11:59:08 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id 81F432049F;
	Wed, 11 Dec 2019 10:59:06 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id r76kmHzlHEWR; Wed, 11 Dec 2019 10:59:05 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by silver.osuosl.org (Postfix) with ESMTP id 554C322DC7;
	Wed, 11 Dec 2019 10:58:47 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by ash.osuosl.org (Postfix) with ESMTP id 6A94A1BF476
 for <devel@linuxdriverproject.org>; Wed, 11 Dec 2019 10:58:31 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id 5A49822D55
 for <devel@linuxdriverproject.org>; Wed, 11 Dec 2019 10:58:31 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id Op-K9FiiXofj for <devel@linuxdriverproject.org>;
 Wed, 11 Dec 2019 10:58:22 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from userp2130.oracle.com (userp2130.oracle.com [156.151.31.86])
 by silver.osuosl.org (Postfix) with ESMTPS id 47C922049F
 for <devel@driverdev.osuosl.org>; Wed, 11 Dec 2019 10:58:22 +0000 (UTC)
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
 by userp2130.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xBBAnVD1104680;
 Wed, 11 Dec 2019 10:58:14 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com;
 h=date : from : to : cc
 : subject : message-id : references : mime-version : content-type :
 in-reply-to; s=corp-2019-08-05;
 bh=oQsnxCV0eNnqvhahea86FcYUmwCS+IkmKPLjRKmaz8c=;
 b= 9A== 
Received: from userp3020.oracle.com (userp3020.oracle.com [156.151.31.79])
 by userp2130.oracle.com with ESMTP id 2wrw4n8qs9-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Wed, 11 Dec 2019 10:58:13 +0000
Received: from pps.filterd (userp3020.oracle.com [127.0.0.1])
 by userp3020.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xBBAs4px171614;
 Wed, 11 Dec 2019 10:58:13 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
 by userp3020.oracle.com with ESMTP id 2wte9bshk7-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
 Wed, 11 Dec 2019 10:58:12 +0000
Received: from abhmp0020.oracle.com (abhmp0020.oracle.com [141.146.116.26])
 by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id xBBAwAIm028056;
 Wed, 11 Dec 2019 10:58:10 GMT
Received: from kadam (/129.205.23.165) by default (Oracle Beehive Gateway v4.0)
 with ESMTP ; Wed, 11 Dec 2019 02:58:05 -0800
Date: Wed, 11 Dec 2019 13:57:57 +0300
...
Message-ID: <20191211105757.GC2070@kadam>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 suspectscore=2
 ...
 engine=8.0.1-1911140001 definitions=main-1912110096
X-Proofpoint-Virus-Version: vendor=nai engine=6000 definitions=9467
 signatures=668685
...
Better to preserve the error codes.
...
"corese" is confusing.  "core_enable" would be better.
...
These globals are ugly.  It would be slightly better to pass them
as a parameter.  Or maybe just set this up directly in probe() instead
of hidden in a function like this.
...
This enum is basically a duplicate of mac_id.  Only MAC2 is used.  Can't
we just use MAC_2 and delete this?  Is MAX_MAC related to these values
somehow?  Why do we have priv->mac_max when it's always MAX_MAC?
...
The break is missing a tab.  It's deliberate and done in the next
functions as well, but please don't.
...
This MAX_RETRY is only used here.  Just use a literal for these.  We all
know that 2000 is just a made up number.
...
"temp" stands for temperature.  "tmp" is temporary.  Just get rid of
it and use reg_val directly.
...
It looks like the xgmac_enable/disable are reversed.  We want to pause
briefly while we change the hardware and then restart.  It seems that
this code was never tested so you could look at adding that to your
test cases.
...
> +	xgmac_disable(priv);
        ^^^^^^^^^^^^^^^^^^^
We're leaving the hardeware in a paused state.
...
"retries" wasn't reset to 100 so this could loop for a UINT_MAX
iterations.
...
return 0; is equivalent but more readable to return ret;
