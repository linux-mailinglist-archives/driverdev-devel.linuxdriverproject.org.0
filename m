...
Received: from smtp1.osuosl.org (smtp1.osuosl.org [IPv6:2605:bc80:3010::138])
	by mail.lfdr.de (Postfix) with ESMTPS id D96D84088B4
	for <lists+driverdev-devel@lfdr.de>; Mon, 13 Sep 2021 12:02:48 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp1.osuosl.org (Postfix) with ESMTP id 4006081008;
	Mon, 13 Sep 2021 10:02:47 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp1.osuosl.org ([127.0.0.1])
	by localhost (smtp1.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id pxTtlTaXppR8; Mon, 13 Sep 2021 10:02:46 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp1.osuosl.org (Postfix) with ESMTP id 7C90F80FA6;
	Mon, 13 Sep 2021 10:02:45 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp3.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by ash.osuosl.org (Postfix) with ESMTP id 6BEE81BF381
 for <devel@linuxdriverproject.org>; Mon, 13 Sep 2021 10:02:35 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp3.osuosl.org (Postfix) with ESMTP id 53FEF60604
 for <devel@linuxdriverproject.org>; Mon, 13 Sep 2021 10:02:35 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Authentication-Results: smtp3.osuosl.org (amavisd-new);
 dkim=pass (2048-bit key) header.d=oracle.com header.b="ZAMuxWXr";
 dkim=pass (2048-bit key) header.d=oracle.com header.b="ZKPyJpyg";
 dkim=fail (1024-bit key) reason="fail (body has been altered)"
 header.d=oracle.onmicrosoft.com header.b="ixieC2wv"
Received: from smtp3.osuosl.org ([127.0.0.1])
 by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id ovBymv1E_HEu for <devel@linuxdriverproject.org>;
 Mon, 13 Sep 2021 10:02:34 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com
 [205.220.177.32])
 by smtp3.osuosl.org (Postfix) with ESMTPS id 427D4605FA
 for <devel@driverdev.osuosl.org>; Mon, 13 Sep 2021 10:02:34 +0000 (UTC)
...
X-ClientProxiedBy: JNAP275CA0067.ZAFP275.PROD.OUTLOOK.COM (2603:1086:0:4f::13)
 ...
 (2603:10b6:301:2d::28)
MIME-Version: 1.0
Received: from kadam (62.8.83.99) by JNAP275CA0067.ZAFP275.PROD.OUTLOOK.COM
 (2603:1086:0:4f::13) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.4500.14 via Frontend
 Transport; Mon, 13 Sep 2021 10:02:18 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(366004)(136003)(39860400002)(396003)(376002)(346002)(44832011)(33656002)(33716001)(86362001)(186003)(66556008)(66946007)(66476007)(26005)(9686003)(83380400001)(38100700002)(956004)(38350700002)(8936002)(9576002)(316002)(478600001)(4326008)(2906002)(6666004)(54906003)(52116002)(6496006)(5660300002)(55016002)(6916009)(8676002)(1076003)(66574015);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Sep 2021 10:02:23.1569 (UTC)
...
> @@ -299,10 +299,9 @@ int hif_join(struct wfx_vif *wvif, const struct ieee=
80211_bss_conf *conf,
>  =
