...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id AF0491B5F92
	for <lists+driverdev-devel@lfdr.de>; Thu, 23 Apr 2020 17:39:54 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id 47B3023543;
	Thu, 23 Apr 2020 15:39:53 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id Pii-ytWhkt63; Thu, 23 Apr 2020 15:39:52 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by silver.osuosl.org (Postfix) with ESMTP id 77C5F234BD;
	Thu, 23 Apr 2020 15:39:44 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by ash.osuosl.org (Postfix) with ESMTP id E0B781BF3DB
 for <devel@linuxdriverproject.org>; Thu, 23 Apr 2020 15:39:41 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id D8030234B3
 for <devel@linuxdriverproject.org>; Thu, 23 Apr 2020 15:39:41 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id Ia6lLMj7qCF2 for <devel@linuxdriverproject.org>;
 Thu, 23 Apr 2020 15:39:36 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mout.gmx.net (mout.gmx.net [212.227.15.15])
 by silver.osuosl.org (Postfix) with ESMTPS id 36A25233B0
 for <devel@driverdev.osuosl.org>; Thu, 23 Apr 2020 15:39:35 +0000 (UTC)
...
Subject: [PATCH v3 1/2] staging: vt6656: Check the return value of
...
@@ -528,7 +530,8 @@ void vnt_set_vga_gain_offset(struct vnt_private *priv, u8 data)
 	else
...
+	int ret;
 	...
 	switch (priv->rf_type) {
 	case RF_AL2230:
@@ -597,7 +601,7 @@ void vnt_update_pre_ed_threshold(struct vnt_private *priv, int scanning)
 	}
...
@@ -608,14 +612,17 @@ void vnt_update_pre_ed_threshold(struct vnt_private *priv, int scanning)
