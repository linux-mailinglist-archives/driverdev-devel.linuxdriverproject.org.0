...
Received: from smtp2.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D70C6134F1
	for <lists+driverdev-devel@lfdr.de>; Mon, 31 Oct 2022 12:52:53 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp2.osuosl.org (Postfix) with ESMTP id 481AB408ED;
	Mon, 31 Oct 2022 11:52:49 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 481AB408ED
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
	by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id K7dQpvpX7y7A; Mon, 31 Oct 2022 11:52:46 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp2.osuosl.org (Postfix) with ESMTP id 40275408D3;
	Mon, 31 Oct 2022 11:52:45 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 40275408D3
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by ash.osuosl.org (Postfix) with ESMTP id 8E43F1BF2FD
 for <devel@linuxdriverproject.org>; Mon, 31 Oct 2022 11:52:41 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id 6C274401C7
 for <devel@linuxdriverproject.org>; Mon, 31 Oct 2022 11:52:41 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp4.osuosl.org 6C274401C7
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
 by localhost (smtp4.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id qFXDAnJNRO_G for <devel@linuxdriverproject.org>;
 Mon, 31 Oct 2022 11:52:36 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp4.osuosl.org 8F039402BC
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by smtp4.osuosl.org (Postfix) with ESMTPS id 8F039402BC
 for <devel@linuxdriverproject.org>; Mon, 31 Oct 2022 11:52:36 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6500,9779,10516"; a="395192756"
X-IronPort-AV: E=Sophos;i="5.95,227,1661842800"; d="scan'208";a="395192756"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2022 04:52:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10516"; a="776106391"
X-IronPort-AV: E=Sophos;i="5.95,227,1661842800"; d="scan'208";a="776106391"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by fmsmga001.fm.intel.com with ESMTP; 31 Oct 2022 04:52:31 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1opTLD-000Cuh-05;
 Mon, 31 Oct 2022 11:52:31 +0000
Date: Mon, 31 Oct 2022 19:52:23 +0800
...
Subject: Re: [PATCH v8 2/4] drm/loongson: Add GPIO and I2C driver for
 loongson drm.
Message-ID: <202210311943.1Y5h6bjE-lkp@intel.com>
References: <20221031092418.2980766-2-lichenyang@loongson.cn>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="hfgxmrx5LHTkxrQK"
Content-Disposition: inline
In-Reply-To: <20221031092418.2980766-2-lichenyang@loongson.cn>
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667217156; x=1698753156;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=TDGNqANLH6hgF/f90iVxz4vTMWiLNUJI5haBOLW+LjU=;
 b=OdrskjdQ59jAh9KlpvYedSeitdrCcqNn4qQqLOAmTk2PqQrgw63k53sQ
 6a9rlLyALO0viQBOEyrjYmg/rJLS8G/5WKNNsrbbRBtIYdRE2JJ5NAbkr
 GCaWLEyBv17+p8cKYyCiWhRIkWoQ0R5K8gX/DryT1c8rHkKx+l0Szu8zU
 xuY4mMByjSucMurrLoQNbt9fKvIAFoCOu8fjhEkrieYCJQaruXnz9UaeA
 ezS4AOJ/61iGtUupT6e6v1KAD9NIUEeihKypr2lEwPPkOEcS6hxfFxssI
 xHyTi/TNFgWCw/6MWwt1gFD4Z9xxRaHltxpp6w3hAAuyfeY+/21xZV+sE
 Q==;
X-Mailman-Original-Authentication-Results: smtp4.osuosl.org;
 dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com
 header.a=rsa-sha256 header.s=Intel header.b=OdrskjdQ
...
[also build test WARNING on linus/master v6.1-rc3 next-20221031]
...
patch link:    https://lore.kernel.org/r/20221031092418.2980766-2-lichenyang%40loongson.cn
patch subject: [PATCH v8 2/4] drm/loongson: Add GPIO and I2C driver for loongson drm.
config: sparc-allyesconfig
compiler: sparc64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/2fa64b3542c557114c89f87d0df748c237bd0b07
        ...
        git checkout 2fa64b3542c557114c89f87d0df748c237bd0b07
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=sparc SHELL=/bin/bash drivers/gpu/drm/loongson/
...
>> drivers/gpu/drm/loongson/loongson_encoder.c:9:27: warning: no previous prototype for 'loongson_bridge_detect' [-Wmissing-prototypes]
       9 | enum drm_connector_status loongson_bridge_detect(struct drm_bridge *bridge)
         |                           ^~~~~~~~~~~~~~~~~~~~~~


vim +/loongson_bridge_detect +9 drivers/gpu/drm/loongson/loongson_encoder.c

     8	
   > 9	enum drm_connector_status loongson_bridge_detect(struct drm_bridge *bridge)
    10	{
    11		unsigned char start = 0x0;
    12		struct i2c_msg msgs = {
    13			.addr = DDC_ADDR,
    14			.flags = 0,
    15			.len = 1,
    16			.buf = &start,
    17		};
    18	
    19		if (i2c_transfer(bridge->ddc, &msgs, 1) != 1)
    20			return connector_status_disconnected;
    21		else
