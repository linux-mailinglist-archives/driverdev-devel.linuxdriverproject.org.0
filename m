...
Received: from smtp1.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 085E244B5DB
	for <lists+driverdev-devel@lfdr.de>; Tue,  9 Nov 2021 23:21:06 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp1.osuosl.org (Postfix) with ESMTP id A7C0481886;
	Tue,  9 Nov 2021 22:21:04 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp1.osuosl.org ([127.0.0.1])
	by localhost (smtp1.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id HXfUhxeO3esU; Tue,  9 Nov 2021 22:21:03 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp1.osuosl.org (Postfix) with ESMTP id A494281815;
	Tue,  9 Nov 2021 22:21:01 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by ash.osuosl.org (Postfix) with ESMTP id 86E741BF3C2
 for <devel@linuxdriverproject.org>; Tue,  9 Nov 2021 22:19:48 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id 76B13400FE
 for <devel@linuxdriverproject.org>; Tue,  9 Nov 2021 22:19:48 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
...
Received: from smtp4.osuosl.org ([127.0.0.1])
 ...
 with ESMTP id yqYf24OdMTck for <devel@linuxdriverproject.org>;
 Tue,  9 Nov 2021 22:19:47 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by smtp4.osuosl.org (Postfix) with ESMTPS id 35E4F40461
 for <devel@driverdev.osuosl.org>; Tue,  9 Nov 2021 22:19:47 +0000 (UTC)
Received: by mail.kernel.org (Postfix) with ESMTPSA id EB4E561027;
 Tue,  9 Nov 2021 22:19:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1636496386;
 bh=dsFIpYEaGEOOi3kJDzkmY/MchMa4wnKDTSrg6TDLXdg=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Sasha Levin <sashal@kernel.org>
To: linux-kernel@vger.kernel.org,
	stable@vger.kernel.org
Subject: [PATCH AUTOSEL 5.14 23/75] staging: rtl8723bs: remove possible
 deadlock when disconnect (v2)
Date: Tue,  9 Nov 2021 17:18:13 -0500
Message-Id: <20211109221905.1234094-23-sashal@kernel.org>
...
index c128d462c6c74..e4250be5e816a 100644
--- a/drivers/staging/rtl8723bs/core/rtw_mlme_ext.c
+++ b/drivers/staging/rtl8723bs/core/rtw_mlme_ext.c
@@ -5922,7 +5922,6 @@ u8 chk_bmc_sleepq_hdl(struct adapter *padapter, unsigned char *pbuf)
...
-	struct xmit_priv *pxmitpriv = &padapter->xmitpriv;
 	...
 	/* for BC/MC Frames */
@@ -5933,8 +5932,7 @@ u8 chk_bmc_sleepq_hdl(struct adapter *padapter, unsigned char *pbuf)
...
@@ -5957,8 +5955,7 @@ u8 chk_bmc_sleepq_hdl(struct adapter *padapter, unsigned char *pbuf)
...
index d4c1725718d94..865c09c864237 100644
...
index a05d43b716ee3..5e89f32ae9ce2 100644
--- a/drivers/staging/rtl8723bs/hal/rtl8723bs_xmit.c
+++ b/drivers/staging/rtl8723bs/hal/rtl8723bs_xmit.c
@@ -508,9 +508,7 @@ s32 rtl8723bs_hal_xmit(
