...
Received: from smtp3.osuosl.org (smtp3.osuosl.org [IPv6:2605:bc80:3010::136])
	by mail.lfdr.de (Postfix) with ESMTPS id B6B0733A757
	for <lists+driverdev-devel@lfdr.de>; Sun, 14 Mar 2021 19:13:09 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp3.osuosl.org (Postfix) with ESMTP id 80AEF6F4F3;
	Sun, 14 Mar 2021 18:13:07 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp3.osuosl.org ([127.0.0.1])
	by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id uPLUSOhHSG5a; Sun, 14 Mar 2021 18:13:04 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by smtp3.osuosl.org (Postfix) with ESMTP id F048D605DB;
	Sun, 14 Mar 2021 18:13:00 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from smtp1.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by ash.osuosl.org (Postfix) with ESMTP id 472E91BF414
 for <devel@linuxdriverproject.org>; Sun, 14 Mar 2021 18:12:50 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp1.osuosl.org (Postfix) with ESMTP id 2C61383C44
 for <devel@linuxdriverproject.org>; Sun, 14 Mar 2021 18:12:50 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
...
Received: from smtp1.osuosl.org ([127.0.0.1])
 ...
 with ESMTP id XHueMuhpeyNe for <devel@linuxdriverproject.org>;
 Sun, 14 Mar 2021 18:12:47 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.8.0
Received: from mail-wr1-x42a.google.com (mail-wr1-x42a.google.com
 [IPv6:2a00:1450:4864:20::42a])
 by smtp1.osuosl.org (Postfix) with ESMTPS id B971383A97
 for <devel@driverdev.osuosl.org>; Sun, 14 Mar 2021 18:12:46 +0000 (UTC)
Received: by mail-wr1-x42a.google.com with SMTP id e9so4566874wrw.10
 for <devel@driverdev.osuosl.org>; Sun, 14 Mar 2021 11:12:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to:user-agent;
 bh=kISt7TSoqr8zUs1IzfNmGaFGSsvCqJvcujWTAhNg6ZM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=kISt7TSoqr8zUs1IzfNmGaFGSsvCqJvcujWTAhNg6ZM=;
 b=
X-Gm-Message-State: AOAM532cB+Aseof4OeBCjd3+X/Y7TZ/tg66Efu/dgiX254hscVN7+pQA
 82X7s+3Ez3+3otwvZxO8OpXpHtDvd0ANsg==
X-Google-Smtp-Source: ABdhPJzvmsl0xdKxXv/6trgBCPaFgypZb31uY0d0ILLVPvkJ/fRCqVP2dQSD7yLQzyahhgz9Uh5EzQ==
X-Received: by 2002:a5d:6312:: with SMTP id i18mr24210669wru.149.1615745564691; 
 Sun, 14 Mar 2021 11:12:44 -0700 (PDT)
Received: from agape.jhs (an-19-176-195.service.infuturo.it. [151.19.176.195])
 by smtp.gmail.com with ESMTPSA id
 k11sm10119841wmj.1.2021.03.14.11.12.42
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 14 Mar 2021 11:12:44 -0700 (PDT)
Date: Sun, 14 Mar 2021 19:12:40 +0100
From: Fabio Aiuto <fabioaiuto83@gmail.com>
To: gregkh@linuxfoundation.org
Subject: [PATCH v3 2/2] staging: rtl8723bs: remove unused code blocks
 conditioned by never set CONFIG_WOWLAN
Message-ID: <1d4e09852ff08e7121e9dd6d2d55d819d53ed702.1615744948.git.fabioaiuto83@gmail.com>
...
index 59d42bd4f032..61fd643c244f 100644
...
index 0eac9cb11cef..618b40ede2e4 100644
...
index 97e8e462d718..56ebf18a4c05 100644
...
index a6e49c5494e6..eca394a8e565 100644
...
-#endif /* CONFIG_GTK_OL */
 ...
 /*  */
 /*     Structure    -------------------------------------------------- */
@@ -243,25 +186,13 @@ struct RSVDPAGE_LOC {
 	u8 LocNullData;
 	u8 LocQosNull;
 	u8 LocBTQosNull;
-#ifdef CONFIG_WOWLAN
...
index 5f2784c7cc16..da3679d2c8f9 100644
...
index a7fa82586967..8b6e4e9578f9 100644
...
index 20eafa1eeafa..33e33591006d 100644
...
index 6c1483989ea3..3f3fd19d61c3 100644
...
index 28fb9f26466b..78a9091661a5 100644
...
index 6a28420cdb2f..9ee95fe4266e 100644
...
index b6977f6ece85..d8cdce0539af 100644
