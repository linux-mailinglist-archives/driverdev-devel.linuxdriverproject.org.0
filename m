...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A3BCB77C4
	for <lists+driverdev-devel@lfdr.de>; Thu, 19 Sep 2019 12:51:40 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id F034122091;
	Thu, 19 Sep 2019 10:51:37 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 2kP4Q5haFDh4; Thu, 19 Sep 2019 10:51:37 +0000 (UTC)
Received: from ash.osuosl.org (ash.osuosl.org [140.211.166.34])
	by silver.osuosl.org (Postfix) with ESMTP id 2C97721FFB;
	Thu, 19 Sep 2019 10:51:16 +0000 (UTC)
X-Original-To: devel@linuxdriverproject.org
Delivered-To: driverdev-devel@osuosl.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by ash.osuosl.org (Postfix) with ESMTP id 12BBD1BF324
 for <devel@linuxdriverproject.org>; Thu, 19 Sep 2019 10:51:13 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 003F5866A7
 for <devel@linuxdriverproject.org>; Thu, 19 Sep 2019 10:51:13 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 9xkaWCndlTRT for <devel@linuxdriverproject.org>;
 Thu, 19 Sep 2019 10:51:07 +0000 (UTC)
X-Greylist: delayed 03:36:23 by SQLgrey-1.7.6
Received: from NAM03-CO1-obe.outbound.protection.outlook.com
 (mail-eopbgr790097.outbound.protection.outlook.com [40.107.79.97])
 by whitealder.osuosl.org (Postfix) with ESMTPS id AE7BB84468
 for <devel@driverdev.osuosl.org>; Thu, 19 Sep 2019 10:51:07 +0000 (UTC)
Received: from MN2PR04MB6270.namprd04.prod.outlook.com (2603:10b6:208:e5::22)
 by BN8PR04MB6257.namprd04.prod.outlook.com (2603:10b6:408:4f::25)
...
x-microsoft-antispam: BCL:0; PCL:0;
 ...
 SRVR:MN2PR04MB6270; 
X-MS-TrafficTypeDiagnostic: MN2PR04MB6270:|MN2PR04MB6270:|BN8PR04MB6257:
...
x-forefront-antispam-report: SFV:NSPM;
 SFS:(10019020)(39850400004)(396003)(376002)(346002)(366004)(136003)(189003)(199004)(102836004)(186003)(7736002)(305945005)(2501003)(14444005)(6506007)(256004)(26005)(25786009)(11346002)(476003)(2616005)(446003)(486006)(5024004)(86362001)(107886003)(6512007)(14454004)(478600001)(386003)(71200400001)(8936002)(71190400001)(81166006)(8676002)(4326008)(66066001)(36756003)(5660300002)(81156014)(66446008)(99286004)(66476007)(66556008)(64756008)(66946007)(2906002)(52116002)(76176011)(6486002)(561924002)(316002)(6436002)(30864003)(3846002)(118296001)(6116002)(110136005)(54906003)(569006);
 DIR:OUT; SFP:1102; SCL:1; SRVR:MN2PR04MB6270;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 19 Sep 2019 06:58:43.9587 (UTC)
...
+
+	ret = of_property_read_u32(dev->of_node, "anx,low_power_mode",
+				   &pdata->low_power_mode);
+	if (ret)
+		pdata->low_power_mode = 1; /* default low power mode */
+
+	ret = of_property_read_u32(dev->of_node, "anx,dsi_supported",
+				   &pdata->dsi_supported);
+	if (ret)
+		pdata->dsi_supported = 1; /* default dsi mode */
+
+	ret = of_property_read_u32(dev->of_node, "anx,extcon_supported",
+				   &pdata->extcon_supported);
+	if (ret)
+		pdata->extcon_supported = 0;
+
+	ret = of_property_read_u32(dev->of_node, "anx,internal_pannel",
